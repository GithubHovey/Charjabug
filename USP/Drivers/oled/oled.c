...
//#include "oledfont.h"
#include "spi.h"
//#define OLED_DC_Set HAL_GPIO_WritePin(&GPIOC, GPIO_PIN_10, GPIO_PIN_SET)
...
// 		if(m==0)
// 		{
// 	    OLED_ShowChinese(64,16,t,16,mode); //写入一个汉字保存在OLED_GRAM[][]数组中
// 			t++;
// 		}
// 		if(t==num)
// 			{
